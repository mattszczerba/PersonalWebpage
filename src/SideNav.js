            ...
            <ul>
                <li>
                    <a href="https://www.linkedin.com/in/matt-szczerba-240278140" target="blank" title="linkedin.com">
                        <img className="navimg" src="https://res.cloudinary.com/dow8www4d/image/upload/v1643235594/Webpage/linkedin.png"/>
                    </a>
                </li>
                <li>
                    <a href="https://github.com/mattszczerba" target="blank" title="github.com">
                        <img className="navimg" src="https://res.cloudinary.com/dow8www4d/image/upload/v1643235594/Webpage/github.png" />
                    </a>
                </li>
                <li>
                    <a href="https://www.facebook.com/matt.szczerba/" target="blank" title="Facebook.com">
                        <img className="navimg" src="https://res.cloudinary.com/dow8www4d/image/upload/v1643235594/Webpage/facebook.png"/>
                    </a>
                </li>
                <li>
                    <a href="https://www.instagram.com/skwizzerbz/" target="blank" title="instagram.com">
                        <img className="navimg" src="https://res.cloudinary.com/dow8www4d/image/upload/v1643235595/Webpage/instagram.png"/>
                    </a>
                </li>
            </ul>
        </nav>
